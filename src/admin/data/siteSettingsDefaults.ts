    ...
    dictionaries: [
      {
        ...
        name: 'Категория',
        values: [
          { id: 'category-1', value: 'Футболки', color: '' },
          { id: 'category-2', value: 'Худи', color: '' },
          { id: 'category-3', value: 'Рубашки', color: '' },
        ],
      },
      {
        id: 'size',
        name: 'Размер',
        values: [
          { id: 'size-1', value: 'XS', color: '' },
          { id: 'size-2', value: 'S', color: '' },
          { id: 'size-3', value: 'M', color: '' },
          { id: 'size-4', value: 'L', color: '' },
          { id: 'size-5', value: 'XL', color: '' },
        ],
      },
      {
        id: 'color',
        name: 'Цвет',
        values: [
          { id: 'color-1', value: 'Черный', color: '' },
          { id: 'color-2', value: 'Белый', color: '' },
          { id: 'color-3', value: 'Серый', color: '' },
          { id: 'color-4', value: 'Синий', color: '' },
        ],
      },
      {
        id: 'fit',
        name: 'Посадка',
        values: [
          { id: 'fit-1', value: 'Slim', color: '' },
          { id: 'fit-2', value: 'Regular', color: '' },
          { id: 'fit-3', value: 'Oversize', color: '' },
        ],
      },
      {
        id: 'material',
        name: 'Материал',
        values: [
          { id: 'material-1', value: 'Хлопок', color: '' },
          { id: 'material-2', value: 'Лен', color: '' },
          { id: 'material-3', value: 'Вискоза', color: '' },
        ],
      },
      {
        id: 'season',
        name: 'Сезон',
        values: [
          { id: 'season-1', value: 'Весна', color: '' },
          { id: 'season-2', value: 'Лето', color: '' },
          { id: 'season-3', value: 'Осень', color: '' },
          { id: 'season-4', value: 'Зима', color: '' },
        ],
      },
      {
        id: 'availability',
        name: 'Наличие',
        values: [
          { id: 'availability-1', value: 'В наличии', color: '' },
          { id: 'availability-2', value: 'Нет в наличии', color: '' },
          { id: 'availability-3', value: 'Предзаказ', color: '' },
        ],
      },
    ],
  }
